...
import type { Engine, EngineEvaluation, EvaluateFenOptions } from '../../../packages/engine/src/stockfishWasm';
...
class DeterministicEngine implements Engine {
  ...
  public async evalFen(fen: string, _options: EvaluateFenOptions): Promise<EngineEvaluation> {
    if (!this.ready) {
