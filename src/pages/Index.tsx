        ...
        <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-16 px-6 py-12">
          ...
          >
            ...
            <div className="flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-5 py-2 text-xs uppercase tracking-[0.4em] text-cyan-100/80 shadow-[0_0_25px_rgba(34,211,238,0.35)]">
              ...
              <span>Rule Architect V2</span>
              <span className="hidden sm:inline">·</span>
              <span className="hidden sm:inline">Moteur déterministe</span>
            </div>
          </motion.header>
          ...
          >
            ...
            >
              ...
              <Button
                ...
                className="group flex w-full items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-amber-400 via-orange-400 to-pink-500 py-6 text-lg font-semibold text-black shadow-[0_0_55px_rgba(251,191,36,0.35)] transition-transform hover:-translate-y-0.5"
              >
                <span>
                  {mode === "ia"
                    ? "Lancer un Blitz contre l'IA"
                    : user
              ...
              <div className="flex items-center justify-between text-xs text-amber-100/70">
                ...
                <span>Configuration confirmée avant le départ</span>
              </div>
            </motion.div>
          </section>
        </div>
